...
icono = pygame.image.load("images/spaceship.png")
...
img_jugador = pygame.image.load("images/rocket.png")
jugador_x = 368
jugador_y = 500
jugador_x_cambio = 0
...
for e in range(cantidad_enemigos):
    ...
    img_enemigo.append(pygame.image.load("images/cthulhu.png"))
...
balas = []
img_bala = pygame.image.load("images/bullet.png")
bala_x = 0
bala_y = 500
bala_x_cambio = 0
bala_y_cambio = 4
...
# puntaje
puntaje = 0
fuente = pygame.font.Font('fuentes/From Cartoon Blocks.ttf', 32)
texto_x = 10
texto_y = 10

# texto final de juego
final = pygame.font.Font('fuentes/From Cartoon Blocks.ttf', 40)
